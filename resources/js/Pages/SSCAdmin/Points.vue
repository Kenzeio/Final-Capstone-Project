                    ...
                    <div class="flex justify-between items-center">
                        <div class="search flex space-x-2 items-center">
                            ...
                            <div class="text-sm font-medium text-gray-700">
                                <p>Number of Points: <span>{{ points.length }}</span></p>
                            </div>
                        </div>
                        <!--Buttons-->
                        <div class="flex items-center space-x-2.5">
                            <button @click="openModal(false)" class="tooltip-btn bg-blue-800 text-white py-2 px-3 rounded-lg text-sm font-medium shadow hover:bg-blue-800/90 transition-colors" data-tooltip="Add new Point System">
